...
import org.acme.service.RecTranBirtService;
...
@Path("/tranReport")
public class RecTranBirtResource {

    @Inject
    RecTranBirtService birtService;
    ...
    public Response generateReport(@QueryParam("voucherNumber") String voucherNumber) {
        try {
            ...
            params.put("voucherNumber", voucherNumber); // Parameter name should match BIRT design
